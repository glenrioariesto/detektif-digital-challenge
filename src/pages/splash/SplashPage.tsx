...
export function SplashPage({ onStart }: SplashPageProps) {
  return (
    <div className="min-h-screen w-screen bg-[#070514] relative flex flex-col items-center justify-center p-4 md:p-6 text-slate-100 scanlines select-none overflow-hidden animate-fadeIn">
